...
class TrajectoryIntegrator:
    ...
    def _create_model_inputs(self, start_point, lattice_vector, velocity):
        ...
        eeturns the inputs for the force model at the starting point of the trajectory. A value of 1 returns the inputs at the first
...
if __name__ == '__main__':
    ...
    model = DummyRegressor().fit([[0,]*8], [1], verbose =0)
